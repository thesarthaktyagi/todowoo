    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'todo_app/signupuser.html', {'form': UserCreationForm(), 'error': 'That username is already taken. Please choose another username'})
...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo_app/createtodo.html', {'form': TodoForm(), 'error': 'Bad Data Is Passed. Try Again'})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo_app/viewtodo.html', {'todo': todo, 'form': form, 'error': 'Bad Info. Try Again'})
